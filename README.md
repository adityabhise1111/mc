...
time 12T; Conversion clock Fosc/64
}
...
for(i=0;i<10;i++) //Display the 10 bit ADC result
on LCD
{
if(tempv&0x200)
 {
...
ADCVal=(5500/1024)*ADCVal; //Convert binary data to
mV; 1 bit <=> (5500/1024)mV
sprintf(text,"ADC value=%4dmv",ADCVal); //Convert integer data
to string
...
GENERATION OF PWM FOR DC MOTOR CONTROL
// Generation of PWM signal for DC motor control.(PIC)
#include<p18f4550.h>
